                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>@fat</td>
                                                        <td>pdf ler</td>
                                                        <td><a href="#!" class="label theme-bg2 text-white f-12">Reddet</a><a href="#!" class="label theme-bg text-white f-12">Onayla</a><a href="acıklama2" class="label theme-bg text-white f-12">Açıklama Yap</a></td>
                                                    </tr>
                                                    <tr>
                                                        <td><img class="rounded-circle" style="width:40px;" src="images/user/avatar-2.jpg" alt="activity-user"></td>
                                                        <td>Mark</td>
