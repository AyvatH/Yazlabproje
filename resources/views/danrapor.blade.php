                                            ...
                                            <table class="table table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>PDF Dosyası 3</th>
                                                        <th>Word Dosyası</th>
                                                        <th>Word Dosyası 2</th>
                                                        <th>Word Dosyası 3</th>
                                                        <th>Onayla</th>
                                                        <th>Açıklama</th>
                                                        <th>Reddet</th>
                                                ...
                                                <tbody >
                                                    ...
                                                    <input  type="hidden" class="form-control" name="kad"  {{ $akey2=$val2 ['rapor_id']}} placeholder="Kullanıcı Adı">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $val2 ['soyad'] }}</td>
                                                         ...
                                                         <td><a href="{{url($val2 ["pdf2_path"])}}" type="submit" class="label theme-bg text-white f-12">2.PDF</a></td>
                                                         <td><a href="{{url($val2 ["pdf3_path"])}}" type="submit" class="label theme-bg text-white f-12">3.PDF</a></td>
                                                         <td><a href="{{url($val2 ["word_path"])}}" type="submit" class="label theme-bg text-white f-12">1.Word</a></td>
                                                         <td><a href="{{url($val2 ["word2_path"])}}" type="submit" class="label theme-bg text-white f-12">2.Word</a></td>
                                                         <td><a href="{{url($val2 ["word3_path"])}}" type="submit" class="label theme-bg text-white f-12">3.Word</a></td>
                                                        <td>
                                                            <a href="{{url("raporonayla/".$akey2)}}" type="submit" class="label theme-bg text-white f-12">Onayla</a>

                                                         </td>
                                                         <td>
                                                            <a href="{{url("aciklama2/".$akey2)}}" type="submit" class="label theme-bg text-white f-12">Açıklama</a>

                                                         </td>

                                                         <td>   <a href="{{url("raporreddet/$akey2")}}" type="submit" class="label theme-bg2 text-white f-12">Reddet</a>
                                        </td>
