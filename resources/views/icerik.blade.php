                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Proje Önerisi</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5>Proje Başlığı</h5>
                                        <hr>
                                        <input class="mb-3 form-control form-control-lg" readonly type="text"  value="{{$dataa->baslik}}" name="baslik" placeholder="Proje Başlığı">
                                        <hr>
                                        <h5>Proje Amacı, Önem Ve Kapsamı</h5>
                                        <hr>
                                        <div class="form-group">
                                            <label for="exampleFormControlTextarea1">Minimum 200 Karakter Olmalıdır</label>
                                            <textarea class="form-control" readonly name="materyal"  id="exampleFormControlTextarea1" column="200" rows="6" >{{$dataa->amac}}</textarea>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" readonly name="materyal"  id="exampleFormControlTextarea1" column="200" rows="6" >{{$dataa->materyal}}</textarea>
                                        </div>
                                        <hr>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <hr>
                                        <input class="mb-3 form-control form-control-lg" readonly name="anahtar1" value="{{$dataa->anahtar_kelime}}" type="text" placeholder="Anahtar Kelime-1">
                                        <input class="mb-3 form-control form-control-lg" readonly name="anahtar2" value="{{$dataa->anahtar_kelime2}}" type="text" placeholder="Anahtar Kelime-2">
                                        <input class="mb-3 form-control form-control-lg" readonly name="anahtar3" value="{{$dataa->anahtar_kelime3}}" type="text" placeholder="Anahtar Kelime-3">
                                        <input class="mb-3 form-control form-control-lg" readonly name="anahtar4" value="{{$dataa->anahtar_kelime4}}" type="text" placeholder="Anahtar Kelime-4">
                                        <input class="mb-3 form-control form-control-lg" readonly name="anahtar5" value="{{$dataa->anahtar_kelime5}}" type="text" placeholder="Anahtar Kelime-5">
                                        <hr>
                                        <hr>
                                        <div class="row">
                                            <div class="col-sm-12">
